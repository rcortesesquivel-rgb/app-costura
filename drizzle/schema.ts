...
export const medidas = mysqlTable("medidas", {
  ...
  talleDelantero: varchar("talleDelantero", { length: 10 }),
  alturaButso: varchar("alturaButso", { length: 10 }),
  alturaCardera: varchar("alturaCardera", { length: 10 }),
  siza: varchar("siza", { length: 10 }),
  anchoHombro: varchar("anchoHombro", { length: 10 }),
  notas: text("notas"),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
});
