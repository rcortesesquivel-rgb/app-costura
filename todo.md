...
## Deploy Backend a Railway - 1 Mar 2026
- [x] Crear Dockerfile y railway.json para deploy
- [x] Subir código a GitHub (rcortesesquivel-rgb/app-costura)
- [x] Crear servicio MySQL en Railway
- [x] Configurar DATABASE_URL con referencia a MySQL de Railway
- [x] Corregir binding del servidor a 0.0.0.0
- [x] Eliminar variable PORT manual (conflicto con Railway)
- [x] Corregir archivos SQL vacíos de migraciones
- [x] Backend funcionando en https://app-costura-production.up.railway.app
- [x] Migraciones ejecutándose correctamente
